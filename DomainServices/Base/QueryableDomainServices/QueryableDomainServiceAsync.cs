...
{
    public class QueryableDomainServiceAsync<TEntity, TId> : DisposableClass, IQueryableDomainServiceAsync<TEntity, TId>
        ...
        where TId : struct
    {
        ...
        {
            CheckForObjectAlreadyDisposedOrNot(typeof(QueryableDomainServiceAsync<TEntity, TId>).FullName);
