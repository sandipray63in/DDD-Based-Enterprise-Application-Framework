...
1) OWINMiddleware ->to be used when the functionality needs to be applied at the OWIN/Katana Level.
...
wherever required.And that container in this case is this Common Folder.
