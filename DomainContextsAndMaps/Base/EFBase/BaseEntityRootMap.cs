...
namespace DomainContextsAndMaps.Base.EFBase
{
        ...
        where TEntity : BaseEntity<TId>
    {
        ...
        protected abstract SqlDbType IDColumnType { get; }
        ...
        public BaseEntityRootMap()
        {
            ...
            ExtendPropertyIDWithOtherConfigurations(Property(p => p.Id).HasColumnName(IDColumnName).HasColumnType(IDColumnType.ToString()).HasDatabaseGeneratedOption(DbIdGenerationOption));
