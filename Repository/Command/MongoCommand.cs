...
{
    public class MongoCommand<TEntity, TId> : DisposableClass, ICommand<TEntity>
        ...
        where TId : struct
    {
        ...
        public MongoCommand(MongoContext mongoContext)
        {
            ...
            _mongoCollection = mongoContext.GetMongoCollection<TEntity, TId>();
        }

        public void Insert(TEntity item)
        {
            CheckForObjectAlreadyDisposedOrNot(typeof(MongoCommand<TEntity, TId>).FullName);
